...
// function as Swiper mutator.
type SwiperFunc func(context.Context, *ent.SwiperMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SwiperFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SwiperMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SwiperMutation", m)
}
...
// The XConfigFunc type is an adapter to allow the use of ordinary
// function as XConfig mutator.
type XConfigFunc func(context.Context, *ent.XConfigMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f XConfigFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.XConfigMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.XConfigMutation", m)
}
